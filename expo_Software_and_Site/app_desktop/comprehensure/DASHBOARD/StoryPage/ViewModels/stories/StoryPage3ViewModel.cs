...
/// <summary>
/// ViewModel for StoryPage3
/// </summary>
public class StoryPage3ViewModel : INotifyPropertyChanged
{
    private string _storyText;

    public StoryPage3ViewModel()
    {
        // Initialize story content
        StoryText = "Insert your story text for Module 3 here. This area is scrollable to accommodate longer narratives.";
