...
/// <summary>
/// ViewModel for StoryPage4
/// </summary>
public class StoryPage4ViewModel : INotifyPropertyChanged
{
    private string _storyText;

    public StoryPage4ViewModel()
    {
        // Initialize story content
        StoryText = "Insert your story text for Module 4 here. This area is scrollable to accommodate longer narratives.";
        ModuleTitle = "Module 04";
