...
/// <summary>
/// ViewModel for StoryPage7
/// </summary>
public class StoryPage7ViewModel : INotifyPropertyChanged
{
    private string _storyText;

    public StoryPage7ViewModel()
    {
        // Initialize story content
        StoryText = "Insert your story text for Module 7 here. This area is scrollable to accommodate longer narratives.";
        ModuleTitle = "Module 07";
