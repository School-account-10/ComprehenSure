...
/// <summary>
/// ViewModel for StoryPage8
/// </summary>
public class StoryPage8ViewModel : INotifyPropertyChanged
{
    private string _storyText;

    public StoryPage8ViewModel()
    {
        // Initialize story content
        StoryText = "Insert your story text for Module 8 here. This area is scrollable to accommodate longer narratives.";
        ModuleTitle = "Module 08";
