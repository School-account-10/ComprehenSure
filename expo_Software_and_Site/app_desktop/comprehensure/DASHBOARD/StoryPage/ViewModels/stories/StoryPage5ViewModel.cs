...
/// <summary>
/// ViewModel for StoryPage5
/// </summary>
public class StoryPage5ViewModel : INotifyPropertyChanged
{
    private string _storyText;

    public StoryPage5ViewModel()
    {
        // Initialize story content
        StoryText = "Insert your story text for Module 5 here. This area is scrollable to accommodate longer narratives.";
        ModuleTitle = "Module 05";
